...
public class MetadataRetriever {
    ...
    public Integer getTrackNumber() {
        ...
        if ((trackNumber == null || trackNumber.equals("")) && myMp3Metadata != null) {
            return myMp3Metadata.getTrackNumber() != null && myMp3Metadata.getTrackNumber().intValue() > 0 ?
                    myMp3Metadata.getTrackNumber().intValue() : null;
        }
